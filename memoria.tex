...
%\markright{Antonio Balderas\hfill On page styles\hfill}

%\markboth{\hfill \thechapter \hfill Author's Name}{Author's Name \hfill Book's Title \hfill}
...
\input{cap1_introduction.tex}

\chapter{Metodología}
\input{cap2_metodologia.tex}

\chapter{Resultados}
\input{cap3_resultados.tex}

\chapter{Respuestas}
\input{cap4_discusion.tex}

\chapter{Trabajo en curso y futuro}
\input{cap5_futuro.tex}
